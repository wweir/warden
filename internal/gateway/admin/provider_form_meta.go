...
type providerFormServiceProtocolTemplateMeta struct {
	...
	ResponsesToChat      bool     `json:"responses_to_chat,omitempty"`
		...
		Presets: []providerFormPresetMeta{
			{
				...
				Family:                  config.ProviderFormatOpenAI,
				AuthMode:                "api_key",
			...
			},
			{
				...
				Family:                  config.ProviderFormatAnthropic,
				AuthMode:                "api_key",
			...
			},
			{
				...
				Family:                  config.ProviderFormatCopilot,
				AuthMode:                "config_dir",
		...
		ServiceProtocolTemplates: []providerFormServiceProtocolTemplateMeta{
			{
				...
				Families:         []string{config.ProviderFormatOpenAI, config.ProviderFormatAnthropic, config.ProviderFormatCopilot},
			...
			},
			{
				...
				Families:         []string{config.ProviderFormatOpenAI},
				Backends:         []string{""},
			...
			},
			{
				...
				Families:         []string{config.ProviderFormatAnthropic},
				Backends:         []string{""},
			...
			{
				ID:               "openai_anthropic_native",
				Title:            "OpenAI + Anthropic Native",
				Summary:          "Expose all OpenAI and Anthropic native surfaces for dual-protocol gateways.",
				Families:         []string{},
				Backends:         []string{""},
				ServiceProtocols: []string{config.RouteProtocolChat, config.RouteProtocolResponses, config.ServiceProtocolEmbeddings, config.RouteProtocolAnthropic},
			},
		},
	}
}
