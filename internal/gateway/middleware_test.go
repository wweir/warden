...
func TestAPIKeyAuthMiddlewareBypassesWhenNoKeysConfigured(t *testing.T) {
	handler := (&APIKeyAuthMiddleware{cfg: &config.ConfigStruct{}}).Process(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func TestAPIKeyAuthMiddlewareRejectsMissingOrInvalidKey(t *testing.T) {
