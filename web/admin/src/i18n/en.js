export default {
	...
	config: {
		...
		apiKeyCacheTokens: "Cache Tokens",
	...
	logs: {
		...
		expand: "Expand",
		collapse: "Collapse",
		viewLogDetails: "View row detail",
		...
		streaming: "Streaming",
			confirmClear: "Are you sure you want to clear all logs? This cannot be undone.",
	...
	providerDetail: {
		...
		authSourceStatic: "Static API Key",
		authSourceCommand: "Command",
		authSourceNone: "None",
		authSourceConfigDir: "Config Directory",
		authSourceCLIProxyAuthDir: "Local CLI Credentials (auth_dir)",
		authSourceRuntime: "Auth Source",
		...
		cliproxyAuthImportDesc:
			"Write a complete CLIProxyAPI auth JSON file into cliproxy.auth_dir. This only stores auth file content, not provider config.",
		cliproxyAuthRefresh: "Refresh Files",
		cliproxyAuthPasteLabel: "Auth JSON",
		cliproxyAuthPastePlaceholder: "Paste a complete auth JSON document, or select a local JSON file to fill it.",
		cliproxyAuthFilename: "Filename",
		cliproxyAuthFilenamePlaceholder: "e.g. codex-team-a.json",
		cliproxyAuthUpload: "Import Auth File",
		cliproxyAuthClear: "Clear",
		cliproxyAuthFilesTitle: "auth_dir Files",
		cliproxyAuthFilesEmpty: "No auth files are present in this directory yet.",
		cliproxyAuthValidationValid: "Valid",
		cliproxyAuthValidationWarning: "Warning",
		cliproxyAuthValidationInvalid: "Invalid",
		cliproxyAuthValidationUnknown: "Unknown",
		cliproxyAuthOnlineVerify: "Verify Online",
		cliproxyAuthOnlineChecking: "Verifying...",
		cliproxyAuthOnlineOk: "Online OK",
		cliproxyAuthOnlineError: "Online Error",
		cliproxyAuthUsageLoading: "Loading Usage...",
		cliproxyAuthUsageOk: "Usage OK",
		cliproxyAuthUsageWarning: "Usage Warning",
		cliproxyAuthUsageDisabled: "Disabled",
		cliproxyAuthUsageError: "Usage Error",
		cliproxyAuthUsageUnknown: "No Usage",
		cliproxyAuthUsagePlan: "Plan",
		cliproxyAuthUsageQuotaExceeded: "Quota Cooldown",
		cliproxyAuthUsageModels: "Model States",
		cliproxyAuthUsageCached: "cached",
		cliproxyAuthUsageMetricPlan: "Plan",
		cliproxyAuthUsageMetric5h: "5h Limit",
		cliproxyAuthUsageMetric5hReset: "5h Reset",
		cliproxyAuthUsageMetricWeekly: "Weekly Limit",
		cliproxyAuthUsageMetricWeeklyReset: "Weekly Reset",
		cliproxyAuthUsageMetricAuth: "Auth",
		cliproxyAuthUsageMetricQuota: "Quota",
		cliproxyAuthUsageMetricRecoverAt: "Recover At",
		cliproxyAuthUsageMetricCooldown: "Cooldown",
		cliproxyAuthUsageMetricModel: "Model",
		cliproxyAuthUsageMetricResetAt: "Reset At",
		cliproxyAuthUsageMetricResetAfter: "Reset In",
		cliproxyAuthUsageMetricRemaining: "Remaining",
		cliproxyAuthUsageMetricCredits: "Credits",
		cliproxyAuthDeleting: "Deleting...",
		cliproxyAuthDeleteConfirm: "Delete auth file {filename}?",
		cliproxyAuthDeleteSuccess: "Deleted {filename}",
		cliproxyAuthDeleteFailed: "Delete auth file failed: {error}",
		cliproxyAuthUploadSuccess: "Written {filename}",
		cliproxyAuthUploadFailed: "Auth import failed: {error}",
		...
		apiKeyCommandPlaceholder: "e.g. op read 'op://LLM/OpenAI/api_key'",
		apiKeyCommandTimeout: "Command Timeout",
		apiKeyCommandTTL: "Command Cache TTL",
		apiKeyCommandHint: "A single stdout line is used as the secret. Output is never displayed here.",
		apiKeyCommandSecurityHint: "The command runs as the Warden service user and is trusted operator-only configuration.",
