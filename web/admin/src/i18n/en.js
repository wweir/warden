export default {
	...
	hooks: {
		...
		about: "About",
		aboutDesc:
			"Route hooks intercept tool calls bound to the current route before or after execution. Pattern format: {pattern}. Use {wildcard} as wildcard (e.g. {example1} or {example2} to match all tools). Pre hooks can block execution; post hooks are audit-only.",
		...
		noRoutesConfigured: "No routes are available yet. Create a route first, then configure hooks.",
